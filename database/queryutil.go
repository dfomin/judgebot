...
const voteForPhraseQueryTemplate = `INSERT INTO %s.%s (vote, user_id, judge_phrase_id) VALUES ($1, $2, $3)`
...
func getVoteForPhraseQuery() string {
	return fmt.Sprintf(voteForPhraseQueryTemplate, private.DatabaseName, votes)
}
